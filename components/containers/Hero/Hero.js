...
const Hero = () => {
  return (
    <section className="hero__section">
      <div className="container flex flex-col md:flex-row gap-32 md:gap-8 items-center justify-between max-w-5xl px-6 py-6 pb-24 mx-auto h-max-full ">
        ...
        <div className="hero__img">
          <img
            className="w-10/12  h-auto mx-auto md:mr-auto "
      ...
      <img
        src="/assets/img/hero-text-bg.svg"
        className="hero__text-bg hidden xl:block"
        alt=""
      />
      <img
